...
/**
 * Text slide N matches the on-page copy block that follows image N on the long-form case study
 * (image/text pairs in scroll order). Markup and wording mirror {@link DesignSystemsShowcasePage}
 * (minus chamfered media, figma rules between sections, and some ids to avoid duplicate anchors when
 * the page and overlay both mount).
 */
export function dsScrollOrderTextSlide(k: number): ReactNode {
  const shell = (inner: ReactNode) => <div className={`${DS_DECK_MAX_W} min-w-0`}>{inner}</div>
  ...
  switch (k) {
      ...
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12 mb-8 md:mb-10 lg:mb-12">
            <p className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">Design System Philosophy</p>
            <h2 className="mt-3 font-mono text-[clamp(2.25rem,4.2vw,3.5rem)] font-normal leading-[1.08] tracking-[0.06em] text-fg md:mt-4">
              The systems behind efficient product teams
            </h2>
          </div>

          <div className="col-span-12 md:col-span-6">
            <h3 className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">My design system experience</h3>
            <ChamferFrame
          ...
          <div className="col-span-12 md:col-span-6">
            <h3 className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">Where I&apos;ve built them</h3>
            <ChamferFrame
              className="mt-4 w-full md:mt-5"
            ...
            >
              ...
              />
              <p className="mb-0 mt-4 md:mt-5">Across B2B, B2C, mobile, web, fintech, climate, travel, and enterprise.</p>
            </ChamferFrame>
          </div>
        </FigmaGrid12>,
      )
    ...
    case 2: {
      return shell(
            ...
            <div className="flex w-full flex-col gap-10 md:gap-12">
              <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
                ...
                <div className="col-span-12 md:col-span-6">
                  ...
                  >
                    <p className="m-0 text-sm font-normal text-fg md:text-base">Problems when building without a DS</p>
                    <DsBulletGrid
        ...
        >
          <p className="m-0 text-balance">Most teams don&apos;t need a design system – until they suddenly do</p>
        </ProblemStatementFrame>,
      )
    }
    case 3: {
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12">
            ...
            <h2 className="mt-3 max-w-[min(100%,52rem)] font-mono text-[clamp(1.75rem,3.2vw,2.5rem)] font-normal leading-[1.12] tracking-[-0.02em] text-fg md:mt-4">
          ...
          <div className="col-span-12 self-start md:col-span-6 md:pt-1">
            <ChamferFrame fitContentHeight className="w-full" innerClassName="bg-surface/20 p-5 md:p-6">
      ...
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12">
            ...
            <h2 className="mt-3 max-w-[min(100%,58rem)] font-mono text-[clamp(1.75rem,3.2vw,2.5rem)] font-normal leading-[1.12] tracking-[-0.02em] text-fg md:mt-4">
          ...
          <div className="col-span-12 md:col-span-4">
            <div className="text-[12px] font-normal leading-relaxed text-fg">
              <p className="m-0">I build component libraries designed for actual product usage, not Dribbble screenshots.</p>
            </div>
          </div>
    ...
    case 6: {
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12">
            <p className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">States, variants, and edge cases</p>
            <h2 className="mt-3 max-w-[min(100%,58rem)] font-mono text-[clamp(1.75rem,3.2vw,2.5rem)] font-normal leading-[1.12] tracking-[-0.02em] text-fg md:mt-4">
    ...
    case 7: {
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12">
            <p className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">Rules that prevent chaos</p>
            <h2 className="mt-3 max-w-[min(100%,58rem)] font-mono text-[clamp(1.75rem,3.2vw,2.5rem)] font-normal leading-[1.12] tracking-[-0.02em] text-fg md:mt-4">
    ...
    case 8: {
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12">
            <p className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">Built for real-world products</p>
            <h2 className="mt-3 max-w-[min(100%,58rem)] font-mono text-[clamp(1.75rem,3.2vw,2.5rem)] font-normal leading-[1.12] tracking-[-0.02em] text-fg md:mt-4">
    ...
    case 9: {
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12">
            <p className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">Design ↔ Engineering bridge</p>
            <h2 className="mt-3 max-w-[min(100%,58rem)] font-mono text-[clamp(1.75rem,3.2vw,2.5rem)] font-normal leading-[1.12] tracking-[-0.02em] text-fg md:mt-4">
    ...
    case 10: {
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12">
            <p className="m-0 font-mono text-lg font-normal leading-snug text-fg md:text-xl">Information architecture for DS</p>
            <h2 className="mt-3 max-w-[min(100%,58rem)] font-mono text-[clamp(1.75rem,3.2vw,2.5rem)] font-normal leading-[1.12] tracking-[-0.02em] text-fg md:mt-4">
      ...
      return shell(
        <FigmaGrid12 className="md:[column-gap:clamp(1.75rem,3.8vw,2.75rem)]">
          <div className="col-span-12 mb-8 w-full min-w-0 text-fg md:mb-10">
            <p className="m-0 font-mono text-sm font-normal leading-snug text-fg md:text-base">What a DS unlocks</p>
            ...
            <div className="mt-6 grid grid-cols-1 gap-8 font-mono md:mt-8 md:grid-cols-2 md:items-start md:gap-8 lg:gap-10">
              <div>
                <p className="m-0 text-[12px] font-normal leading-relaxed text-fg">Across multiple teams, strong systems helped enable:</p>
                <DsBulletGrid
